...
| 服务 | 命令字 | 说明书依据 | 状态 |
| --- | --- | --- | --- |
| 用户服务 | 1001–1004 | 1.4 手机号免密登录、信息维护 | 1001/1002 ✅ 样板<br>1003/1004 待做 |
| 钱包服务 | 1005–1006 | 1.4 余额充值（模拟支付） | 待做 |
| 电站服务 | 1101, 2101–2103 | 1.4 附近充电站、电站管理 | 待做 |
| 电桩服务 | 1102, 2111–2112 | 1.4 电桩详情、远程重启 | 待做 |
| 预约服务 | 1202, 1206 | 1.4 预约充电 | 待做 |
| 订单服务 | 1201, 1207, 2304 | 1.4 未结算订单校验、订单列表 | 待做 |
| 计费结算服务 | 1203–1205 | 1.4 开始充电、计费、结算 | 待做 |
| 用户管理服务 | 2201–2202 | 1.4 模糊搜索、冻结/解冻 | 待做 |
| 统计服务 | 2301–2303 | 1.4 营收指标、趋势、电桩状态分布 | 待做 |

`admin_service.cpp`（2001 管理员登录）也已实现。

## 参照现成实现

**`user_service.cpp` 与 `admin_service.cpp` 是样板，新服务照抄它们的结构最快。** 下面是精简示例：

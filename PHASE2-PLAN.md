...
| 下游验证 | HDFS 为源重跑 profiling → cleaning → validation，**当时 14/14 PASS**，营收仍为 **53,936,279 分**（2026-09-15 三轮补强后校验项增至 82，本地重跑 82/82；HDFS 侧未再重跑，介质无关的断言不受影响） |
...
.venv-phase2/bin/python bigdata/spark/validation.py        # 清洗 5（82/82 必须全过）
